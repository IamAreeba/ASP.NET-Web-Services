<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="StudentInfoService.WebForm1" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" >
        function GetStudentById() {
            ...
            StudentInfoService.StudentService.GetStudentById(id, GetStudentByIdSuccessCallback, GetStudentByIdFailedCallback);
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>
            The time below does not change , when we click the get Student button as we are doing partial page postback and not full page postback.
        </h1>
